...
public class UpdateDataDeleteInterpreter extends AbstractInterpreter implements Interpreter {
	...
	{
		if (obj.getClass() != UpdateDataDelete.class) {
			throw new Exception(UpdateDataDelete.class+" needed as Object. Given: "+obj.getClass());
		}
		
		UpdateDataDelete update = (UpdateDataDelete) obj;
